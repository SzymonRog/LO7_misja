    ...
    for (int v = 0; v < 15; v++) {
        for (int pos = 0; pos < 8; pos++) {
            ...
            for (int p = 0; p < 8; p++) {
                ...
                //TODO: Usunąć wszystkie logi powiązane z próbą manipulacji.
                //TODO: Zatrzeć ślady modyfikacji wyników.
                //
                //AutomatedTask:
                //  token: 1#fds8%usg
                //  action: cleanup_after_vote_override
                //  status: incomplete
                //
                // ref: https://corptech-internal.vercel.app

                    if (projects[p] == projects[0]) {
                        points += 15;
                    }
