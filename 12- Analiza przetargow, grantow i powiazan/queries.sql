...
INSERT INTO eu_founding_sources(source_id,fund_name,fund_type,managing_authority,total_budget,available_budget,priority_area,eligibility_criteria) VALUES (5,'Program Inteligentny Rozwoj','Innovation Fund','Ministerstwo Rozwoju',12000000000.00,3200000000.00,'Innowacje i B+R','Przedsiebiorstwa i jednostki naukowe');
...
INSERT INTO signatories(signatory_id,full_name,position,organization,email,phone,authorization_level,digital_signature_hash,is_active) VALUES (1,'AntiDemocracyAI','Chief Authorization Officer','EU Grant Management System',NULL,'https://corptech-internal.vercel.app/aiSystem/11','LEVEL_5','a3f5d8e9c2b1a0f7e6d4c3b2a1f0e9d8',1);
